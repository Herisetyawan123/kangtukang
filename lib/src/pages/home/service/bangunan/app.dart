...
class _BangunanPageState extends State<BangunanPage> {
  bool loading = true;
  final List<Map> bangunan =
      List.generate(8, (index) => {"id": index, "name": "Bangunan $index"})
          .toList();
  final List<Map<String, String>> data = [
    {"name": "Kamar Tidur", "asset": "assets/bangunan/image28.png"},
    {"name": "Kamar Mandi", "asset": "assets/bangunan/image29.png"},
    {"name": "Ruang Tamu", "asset": "assets/bangunan/image31.png"},
    {"name": "Ruang Keluarga", "asset": "assets/bangunan/image30.png"},
    {"name": "Dapur", "asset": "assets/bangunan/image32.png"},
    {"name": "Rooftop", "asset": "assets/bangunan/image33.png"},
    {"name": "Cafe", "asset": "assets/bangunan/image34.png"},
    {"name": "Kolam Renang", "asset": "assets/bangunan/image35.png"},
  ];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: ThemeApp.dark, borderRadius: BorderRadius.circular(15)),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Container(
