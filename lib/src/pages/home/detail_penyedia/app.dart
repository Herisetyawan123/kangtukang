...
class DetailPenyedia extends StatelessWidget {
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                            image:
                                AssetImage('assets/penyedia_jasa/image16.png'),
                            fit: BoxFit.cover)),
                  ),
                  const SizedBox(
                    width: 30,
  ...
  InkWell btnPesan(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.pushNamed(
        context,
        MyRoutes.calenderTable,
      ),
      child: Container(
        width: MediaQuery.of(context).size.width,
        ...
        decoration: BoxDecoration(
            color: ThemeApp.dark, borderRadius: BorderRadius.circular(10)),
        child: const Center(
          child: Text(
            'Pesan',
            style: TextStyle(
